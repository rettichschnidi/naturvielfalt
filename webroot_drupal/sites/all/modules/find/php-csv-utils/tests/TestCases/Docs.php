 ...
 */
class Test_Of_Csv_Docs extends UnitTestCase {
    ...
    public function test_2_2_Reading_a_csv_file() {
        ...
        $this->assertEqual($captured, 'Widget<br>Whatsamahoozit<br>Dandy Doodad<br>Thingamajigger<br>Jolly Junk<br>Something<br>Cheese Doodles<br>Monkey Juice<br>Plastic Monkeys<br>Steve<br>');
    ...
    public function test_2_2_Other_Methods_Of_Looping_Through_A_File() {
        ...
        $captured = ob_get_clean();
        $this->assertEqual($captured, 'Widget<br>Whatsamahoozit<br>Dandy Doodad<br>Thingamajigger<br>Jolly Junk<br>');
