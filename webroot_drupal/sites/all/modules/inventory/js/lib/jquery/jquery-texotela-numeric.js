...
(function($) {
	 ...
	 * @name numeric
	 * @param decimal
	 *            Decimal separator (e.g. '.' or ',' - default is '.'). Pass
	 *            false for integers
	 * @param callback
	 *            A function that runs if the number is not valid (fires onblur)
	...
	$.fn.numeric = function(decimal, callback) {
		...
		return this.data("numeric.decimal", decimal).data("numeric.callback",
				callback).keypress($.fn.numeric.keypress).blur(
				$.fn.numeric.blur);
	}
	...
	$.fn.removeNumeric = function() {
		return this.data("numeric.decimal", null)
				.data("numeric.callback", null).unbind("keypress",
						$.fn.numeric.keypress)
