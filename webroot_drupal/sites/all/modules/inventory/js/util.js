 ...
 * 
 * @param textField
 *            The text field, where the user can enter the text.
 * @param idField
 *            A hidden input field, where the id will be saved.
 * @param source
 *            The source, where we can get the items for the autocomplete field.
 *            The source must return a JSON in the form [{id, label, ....}]
 * @param onSelect
