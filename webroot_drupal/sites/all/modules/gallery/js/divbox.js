	...
	$.fn.divbox = function(opt,clickObj){
		...
		function _run(index,init){
			...
			fn.init = function(){
				...
				$(requires).remove();
				$(_cfg.container).append('<div id="divbox">'
										 +'</div>'
										 +'<div id="divbox_ajax">'
										 +'</div>'
										 +'<div id="divbox_frame" class="'+(_cfg.skin?_cfg.skin:'divbox_default')+'">'
										 	+'<div class="closed" title="'+_cfg.languages.btn_close+'">'
										 	+'</div>'
										 	+'<div id="divbox_data">'
										 		+'<div id="divbox_content">'
										 		+'</div>'
										 		+'<div class="prev" title="'+_cfg.languages.btn_prev+'">'
										 		+'</div>'
										 		+'<div class="next" title="'+_cfg.languages.btn_next+'">'
										 		+'</div>'
										 	+'</div>'										 		
										 	+'<div class="divbox_media_details">'
										 	+'</div>'
										 +'</div>');
