...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading : Drupal.settings.basePath + 'modules/gallery/images/lightbox-ico-loading.gif', // (string) Path and the name of the loading icon
			imageBtnPrev : Drupal.settings.basePath + 'modules/gallery/images/lightbox-btn-prev.gif', // (string) Path and the name of the prev button image
			imageBtnNext : Drupal.settings.basePath + 'modules/gallery/images/lightbox-btn-next.gif', // (string) Path and the name of the next button image
			imageBtnClose : Drupal.settings.basePath + 'modules/gallery/images/lightbox-btn-close.gif', // (string) Path and the name of the close btn
			imageBlank : Drupal.settings.basePath + 'modules/gallery/images/lightbox-blank.gif', // (string) Path and the name of a blank image (one pixel)
		...
		function _set_interface() {
			...
			$('body').append('<div id="jquery-overlay"></div>' + '<div id="jquery-lightbox">' + '  <div id="lightbox-container-image-box">' + '    <div id="lightbox-container-wrap">' + '      ' + previmage + '' + '      <div id="lightbox-container-image">' + '        <img id="lightbox-image" src="' + settings.imageBlank + '">' + '      </div>' + '    </div>' + '    <div style="" id="lightbox-nav">' + '      <a href="#" id="lightbox-nav-btnPrev"></a>' + '      <a href="#" id="lightbox-nav-btnNext"></a>' + '    </div>' + '    <div id="lightbox-loading">' + '      <a href="#" id="lightbox-loading-link">' + '        <img src="' + settings.imageLoading + '">' + '      </a>' + '    </div>' + '  </div>' + '  <div id="lightbox-container-image-data-box">' + '    <div id="lightbox-container-image-data">' + '      <div id="lightbox-secNav">' + '        <a href="#" id="lightbox-secNav-btnClose">' + '          <img src="' + settings.imageBtnClose + '">' + '        </a>' + '      </div>' + '      <div id="lightbox-image-details">' + caption + number + '</div>' + '    </div>' + '  </div>' + '</div>');
		...
		function _show_image_data() {
			...
			if(settings.imageArray[settings.activeImage][1]) {
				if(settings.captionHTML) {
					$('#lightbox-image-details-caption').empty();
					...
					$('#lightbox-image-details-caption').append(caption).show();
					caption.show();
				} else
