<?php
require_once('AreaHabitatMapper.php');
...
class Application_Model_AreaHabitat extends MainModel
{
...
function __construct() {
     ...
     *
     * @param int $data
     * @return Application_Model_AreaHabitat     
     *
     **/
    ...
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Application_Model_AreaHabitatMapper());
        }
        return $this->_mapper;
    }
