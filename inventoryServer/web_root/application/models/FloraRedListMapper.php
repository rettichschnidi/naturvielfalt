<?php
require_once('DbTable/FloraRedList.php');
...
class Application_Model_FloraRedListMapper {

    /**
     * $_dbTable - instance of Application_Model_DbTable_FloraRedList
     *
     * @var Application_Model_DbTable_FloraRedList     
     */
    protected $_dbTable;
     ...
     * @param string $field
     * @param mixed $value
     * @param Application_Model_FloraRedList $cls
     */     
     ...
     *
     * @param new Application_Model_FloraRedList $cls
     * @return array
     *
     */
    ...
    public function findByField($field, $value, $cls)
    {
            ...
            foreach ($rows as $row) {
                    $cls=new Application_Model_FloraRedList();
                    $result[]=$cls;
                    $cls->setId($row->id)
		->setFloraOrganismId($row->flora_organism_id)
		->setRedListNr($row->red_list_nr)
     ...
     *
     * @param Application_Model_DbTable_FloraRedList $dbTable
     ...
     * 
     * @return Application_Model_DbTable_FloraRedList     
     */
    public function getDbTable()
    {
        if (null === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_FloraRedList');
        }
    ...
    public function save(Application_Model_FloraRedList $cls,$ignoreEmptyValuesOnUpdate=true)
    {
    ...
    public function find($id, Application_Model_FloraRedList $cls)
    {
    ...
    public function fetchAll()
    {
        ...
        foreach ($resultSet as $row) {
            $entry = new Application_Model_FloraRedList();
            $entry->setId($row->id)
                  ->setFloraOrganismId($row->flora_organism_id)
                  ->setRedListNr($row->red_list_nr)
                  ->setIsBerneConvention($row->is_berne_convention)
