<?php
require_once('DbTable/FloraOrganism.php');
...
class Application_Model_FloraOrganismMapper {

    /**
     * $_dbTable - instance of Application_Model_DbTable_FloraOrganism
     *
     * @var Application_Model_DbTable_FloraOrganism     
     */
    protected $_dbTable;
     ...
     * @param string $field
     * @param mixed $value
     * @param Application_Model_FloraOrganism $cls
     */     
     ...
     *
     * @param new Application_Model_FloraOrganism $cls
     * @return array
     *
     */
    ...
    public function findByField($field, $value, $cls)
    {
            ...
            foreach ($rows as $row) {
                    $cls=new Application_Model_FloraOrganism();
                    $result[]=$cls;
                    $cls->setId($row->id)
		->setSisfNr($row->sisf_nr)
		->setStatus($row->status)
     ...
     *
     * @param Application_Model_DbTable_FloraOrganism $dbTable
     ...
     * 
     * @return Application_Model_DbTable_FloraOrganism     
     */
    public function getDbTable()
    {
        if (null === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_FloraOrganism');
        }
    ...
    public function save(Application_Model_FloraOrganism $cls,$ignoreEmptyValuesOnUpdate=true)
    {
    ...
    public function find($id, Application_Model_FloraOrganism $cls)
    {
    ...
    public function fetchAll()
    {
        ...
        foreach ($resultSet as $row) {
            $entry = new Application_Model_FloraOrganism();
            $entry->setId($row->id)
                  ->setSisfNr($row->sisf_nr)
                  ->setStatus($row->status)
                  ->setName($row->name)
