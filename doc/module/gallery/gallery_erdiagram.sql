...
ALTER TABLE public.gallery_image_category
	ADD FOREIGN KEY (gallery_category_option_id)
...
COMMENT ON COLUMN public.gallery_category_condition.gallery_category_id IS 'The primary identifier for a gallery category.';
...
COMMENT ON COLUMN public.gallery_image_category.gallery_category_option_id IS 'The primary identifier for a category option.';
